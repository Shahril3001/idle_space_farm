...
// 5. Special - Apocalypse Flame
  ...
  AbilitiesModel(
    ...
    hpBonus: 20, // Both damage and heal amount
    mpCost: 12,
    cooldown: 3,
    type: AbilityType.attack, // This would need special handling to also heal
    targetType: TargetType.single,
    affectsEnemies: true,
  ),
  AbilitiesModel(
    ...
    name: "Abyssal Fear",
    description: "Terrifies all enemies, reducing their defense and agility.",
    defenseBonus: -10,
    agilityBonus: -10,
    mpCost: 18,
    cooldown: 4,
