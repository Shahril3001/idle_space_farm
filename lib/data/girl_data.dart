...
final List<GirlFarmer> girlsData = [
  ...
  GirlFarmer(
    ...
    stars: 1,
    miningEfficiency: 0.02,
    image: 'assets/images/girls/kaela.png',
    imageFace: 'assets/images/girls/kaela-f.png',
    race: 'Human',
    type: 'Blademaster (Kensai)',
    region: 'Astravia',
    description:
        "Kaela, a spirited farmer from Astravia, dreams of becoming a legendary swordswoman. She trains daily to hone her skills.",
    hp: _generateStats('Common', 'Blademaster (Kensai)')['hp']!,
    mp: _generateStats('Common', 'Blademaster (Kensai)')['mp']!,
    sp: _generateStats('Common', 'Blademaster (Kensai)')['sp']!,
    attackPoints:
  ...
  GirlFarmer(
    ...
    stars: 2,
    miningEfficiency: 0.03,
    image: 'assets/images/girls/nyssa.png',
    imageFace: 'assets/images/girls/nyssa-f.png',
    race: 'Eldren',
    type: 'Arcane Sage (Kenja)',
    region: 'Sylvaris',
    description:
        "Nyssa, a young Eldren mage, has a natural affinity for water magic. She uses her powers to nurture the forests of Sylvaris.",
    hp: _generateStats('Common', 'Arcane Sage (Kenja)')['hp']!,
    mp: _generateStats('Common', 'Arcane Sage (Kenja)')['mp']!,
    sp: _generateStats('Common', 'Arcane Sage (Kenja)')['sp']!,
    attackPoints:
  ...
  GirlFarmer(
    ...
    stars: 1,
    miningEfficiency: 0.01,
    image: 'assets/images/girls/thalia.png',
    imageFace: 'assets/images/girls/thalia-f.png',
    race: 'Daevan',
    type: 'Phantom Reaver (Kageriba)',
    region: 'Ashen Dominion',
    description:
        "Thalia, a stealthy Daevan, uses her agility to outmaneuver her enemies. She fights to protect her clan's honor.",
    hp: _generateStats('Common', 'Phantom Reaver (Kageriba)')['hp']!,
    mp: _generateStats('Common', 'Phantom Reaver (Kageriba)')['mp']!,
    sp: _generateStats('Common', 'Phantom Reaver (Kageriba)')['sp']!,
    attackPoints:
  ...
  GirlFarmer(
    ...
    region: 'Astravia',
    description:
        "Elara, a Therian cleric, channels the light of Solmara to heal the sick and wounded. Her kindness is known throughout Astravia.",
    hp: _generateStats('Common', 'Divine Cleric (Seito)')['hp']!,
    mp: _generateStats('Common', 'Divine Cleric (Seito)')['mp']!,
    sp: _generateStats('Common', 'Divine Cleric (Seito)')['sp']!,
    attackPoints:
  ...
  GirlFarmer(
    ...
    stars: 1,
    miningEfficiency: 0.02,
    image: 'assets/images/girls/rhea.png',
    imageFace: 'assets/images/girls/rhea-f.png',
    race: 'Dracovar',
    type: 'Dread Knight (Jūkishi)',
    region: 'Draknir Sovereignty',
    description:
        "Rhea, a fierce Dracovar warrior, wields her dark magic to defend her homeland. Her draconic heritage gives her unmatched strength.",
    hp: _generateStats('Common', 'Dread Knight (Jūkishi)')['hp']!,
    mp: _generateStats('Common', 'Dread Knight (Jūkishi)')['mp']!,
    sp: _generateStats('Common', 'Dread Knight (Jūkishi)')['sp']!,
    attackPoints:
  ...
  GirlFarmer(
    ...
    stars: 3,
    miningEfficiency: 0.06,
    image: 'assets/images/girls/seren.png',
    imageFace: 'assets/images/girls/seren-f.png',
    race: 'Human',
    type: 'Blademaster (Kensai)',
    region: 'Astravia',
    description:
        "Seren, a rare Blademaster, has mastered the art of the sword. Her precision and speed make her a formidable opponent.",
    hp: _generateStats('Rare', 'Blademaster (Kensai)')['hp']!,
    mp: _generateStats('Rare', 'Blademaster (Kensai)')['mp']!,
    sp: _generateStats('Rare', 'Blademaster (Kensai)')['sp']!,
    attackPoints:
        _generateStats('Rare', 'Blademaster (Kensai)')['attackPoints']!,
    defensePoints:
        _generateStats('Rare', 'Blademaster (Kensai)')['defensePoints']!,
    agilityPoints:
        _generateStats('Rare', 'Blademaster (Kensai)')['agilityPoints']!,
  ),
  GirlFarmer(
    id: 'rare-8',
    name: 'Liora',
    ...
    region: 'Sylvaris',
    description:
        "Liora, a rare Arcane Sage, has mastered the elements. Her spells are as beautiful as they are destructive.",
    hp: _generateStats('Rare', 'Arcane Sage (Kenja)')['hp']!,
    mp: _generateStats('Rare', 'Arcane Sage (Kenja)')['mp']!,
    sp: _generateStats('Rare', 'Arcane Sage (Kenja)')['sp']!,
    attackPoints:
        _generateStats('Rare', 'Arcane Sage (Kenja)')['attackPoints']!,
    defensePoints:
        _generateStats('Rare', 'Arcane Sage (Kenja)')['defensePoints']!,
    agilityPoints:
        _generateStats('Rare', 'Arcane Sage (Kenja)')['agilityPoints']!,
  ),
  GirlFarmer(
    id: 'rare-9',
    name: 'Vesper',
    ...
    stars: 3,
    miningEfficiency: 0.05,
    image: 'assets/images/girls/vesper.png',
    imageFace: 'assets/images/girls/vesper-f.png',
    race: 'Daevan',
    type: 'Phantom Reaver (Kageriba)',
    region: 'Ashen Dominion',
    description:
        "Vesper, a rare Phantom Reaver, moves like a shadow. Her enemies never see her coming until it's too late.",
    hp: _generateStats('Rare', 'Phantom Reaver (Kageriba)')['hp']!,
    mp: _generateStats('Rare', 'Phantom Reaver (Kageriba)')['mp']!,
    sp: _generateStats('Rare', 'Phantom Reaver (Kageriba)')['sp']!,
    attackPoints:
  ...
  GirlFarmer(
    ...
    stars: 4,
    miningEfficiency: 0.08,
    image: 'assets/images/girls/callista.png',
    imageFace: 'assets/images/girls/callista-f.png',
    race: 'Therian',
    type: 'Divine Cleric (Seito)',
    region: 'Astravia',
    description:
        "Callista, a rare Divine Cleric, channels the light of Solmara to heal and protect. Her presence brings hope to the battlefield.",
    hp: _generateStats('Rare', 'Divine Cleric (Seito)')['hp']!,
    mp: _generateStats('Rare', 'Divine Cleric (Seito)')['mp']!,
    sp: _generateStats('Rare', 'Divine Cleric (Seito)')['sp']!,
    attackPoints:
  ...
  GirlFarmer(
    ...
    stars: 3,
    miningEfficiency: 0.06,
    image: 'assets/images/girls/zora.png',
    imageFace: 'assets/images/girls/zora-f.png',
    race: 'Dracovar',
    type: 'Dread Knight (Jūkishi)',
    region: 'Draknir Sovereignty',
    description:
        "Zora, a rare Dread Knight, wields dark magic with unmatched skill. Her loyalty to her homeland is unwavering.",
    hp: _generateStats('Rare', 'Dread Knight (Jūkishi)')['hp']!,
    mp: _generateStats('Rare', 'Dread Knight (Jūkishi)')['mp']!,
    sp: _generateStats('Rare', 'Dread Knight (Jūkishi)')['sp']!,
    attackPoints:
  ...
  GirlFarmer(
    ...
    stars: 5,
    miningEfficiency: 0.10,
    image: 'assets/images/girls/eira.png',
    imageFace: 'assets/images/girls/eira-f.png',
    race: 'Daevan',
    type: 'Blademaster (Kensai)',
    region: 'Ashen Dominion',
    description:
        "Eira, a unique Blademaster, wields her blade with unmatched skill. Her dark past fuels her determination to protect the innocent.",
    hp: _generateStats('Unique', 'Blademaster (Kensai)')['hp']!,
    mp: _generateStats('Unique', 'Blademaster (Kensai)')['mp']!,
    sp: _generateStats('Unique', 'Blademaster (Kensai)')['sp']!,
    attackPoints:
  ...
  GirlFarmer(
    ...
    stars: 6,
    miningEfficiency: 0.12,
    image: 'assets/images/girls/aurelia.png',
    imageFace: 'assets/images/girls/aurelia-f.png',
    race: 'Therian',
    type: 'Arcane Sage (Kenja)',
    region: 'Astravia',
    description:
        "Aurelia, a unique Arcane Sage, commands the elements with unparalleled mastery. Her wisdom and power make her a beacon of hope in Astravia.",
    hp: _generateStats('Unique', 'Arcane Sage (Kenja)')['hp']!,
    mp: _generateStats('Unique', 'Arcane Sage (Kenja)')['mp']!,
    sp: _generateStats('Unique', 'Arcane Sage (Kenja)')['sp']!,
    attackPoints:
  ...
  GirlFarmer(
    ...
    stars: 5,
    miningEfficiency: 0.09,
    image: 'assets/images/girls/nimue.png',
    imageFace: 'assets/images/girls/nimue-f.png',
    race: 'Dracovar',
    type: 'Phantom Reaver (Kageriba)',
    region: 'Draknir Sovereignty',
    description:
        "Nimue, a unique Phantom Reaver, moves like a shadow through the battlefield. Her draconic heritage gives her unmatched agility and strength.",
    hp: _generateStats('Unique', 'Phantom Reaver (Kageriba)')['hp']!,
    mp: _generateStats('Unique', 'Phantom Reaver (Kageriba)')['mp']!,
    sp: _generateStats('Unique', 'Phantom Reaver (Kageriba)')['sp']!,
    attackPoints:
  ...
  GirlFarmer(
    ...
    region: 'Elementara',
    description:
        "Selene, a unique Divine Cleric, channels the light of Solmara to heal and protect. Her connection to Elementara makes her a powerful ally.",
    hp: _generateStats('Unique', 'Divine Cleric (Seito)')['hp']!,
    mp: _generateStats('Unique', 'Divine Cleric (Seito)')['mp']!,
    sp: _generateStats('Unique', 'Divine Cleric (Seito)')['sp']!,
    attackPoints:
  ...
  GirlFarmer(
    ...
    stars: 5,
    miningEfficiency: 0.10,
    image: 'assets/images/girls/morgana.png',
    imageFace: 'assets/images/girls/morgana-f.png',
    race: 'Human',
    type: 'Dread Knight (Jūkishi)',
    region: 'Astravia',
    description:
        "Morgana, a unique Dread Knight, wields dark magic with unmatched skill. Her loyalty to Astravia is unwavering, even in the face of darkness.",
    hp: _generateStats('Unique', 'Dread Knight (Jūkishi)')['hp']!,
    mp: _generateStats('Unique', 'Dread Knight (Jūkishi)')['mp']!,
    sp: _generateStats('Unique', 'Dread Knight (Jūkishi)')['sp']!,
    attackPoints:
  ...
  GirlFarmer(
    ...
    stars: 6,
    miningEfficiency: 0.12,
    image: 'assets/images/girls/isolde.png',
    imageFace: 'assets/images/girls/isolde-f.png',
    race: 'Eldren',
    type: 'Elementalist (Seirei Jutsushi)',
    region: 'Sylvaris',
    description:
        "Isolde, a unique Elementalist, commands the forces of nature with unparalleled mastery. Her wisdom and power make her a beacon of hope in Sylvaris.",
    hp: _generateStats('Unique', 'Elementalist (Seirei Jutsushi)')['hp']!,
    mp: _generateStats('Unique', 'Elementalist (Seirei Jutsushi)')['mp']!,
    sp: _generateStats('Unique', 'Elementalist (Seirei Jutsushi)')['sp']!,
    attackPoints: _generateStats(
